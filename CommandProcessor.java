...
public class CommandProcessor
{
     ...
     * commands to. Creates a command processor with a new database.
     */
     ...
     * and include insert, remove, regionsearch, search, and dump. If the
     * command in the file line is not one of these, an appropriate message will
     * be written in the console. This processor method is called for each line
     * in the file. Note that the methods called will themselves write to the
