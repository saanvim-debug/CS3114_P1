    ...
    extends TestCase
{
    ...
    /**
     * Tests the getter methods for the rectangle's coordinates and dimensions.
     */
    ...
    /**
     * Tests whether rectangles with the same coordinates and dimensions are
     * considered equal.
     */
    ...
    /**
     * Tests that rectangles whose edges only touch are not considered to
     * intersect.
     */
    ...
    /**
     * Tests that a rectangle extending beyond the right boundary of the world
     * box is invalid.
     */
    ...
    /**
     * Tests that a rectangle extending beyond the bottom boundary of the world
     * box is invalid.
     */
    ...
    /**
     * Tests that a rectangle fitting exactly within the world box is valid.
     */
